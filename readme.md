...
### GitHub
1. **Authentication**: Uses Personal Access Token for API authentication
2. **Repository Discovery**: Fetches both personal and organization repositories
3. **Permission Filtering**: Identifies repositories where you have admin access
4. **Collaborator Analysis**: Retrieves all collaborators for each repository
5. **Role Mapping**: Maps GitHub roles to standardized permission levels

### GitLab
1. **Authentication**: Uses Personal Access Token for API authentication
2. **Project Discovery**: Fetches both personal projects and group projects
3. **Access Filtering**: Identifies projects where you have maintainer/owner access
4. **Member Analysis**: Retrieves all members for each project
5. **Level Mapping**: Maps GitLab access levels to standardized permission levels

### Azure DevOps
1. **Authentication**: Uses Personal Access Token for API authentication
2. **Project Discovery**: Fetches all projects in your organization
3. **Repository Filtering**: Identifies repositories where you have admin access
4. **Permission Analysis**: Retrieves user permissions for each repository
5. **Team Integration**: Includes team membership information
...
To see detailed API responses, you can modify the scripts to print response details:
